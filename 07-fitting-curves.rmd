...
```{r}
polynomial3BF <- BayesFactor::lmBF(happiness ~ age + age2 + age3, data = as.data.frame(SurveyData) )
```
...
- What is the _F_-statistic for the test of the model with a linear + quadratic component vs. linear + quadratic + cubic components?
