...
<div class='webex-radiogroup' id='radio_MBBTIXIWHE'><label><input type="radio" autocomplete="off" name="radio_MBBTIXIWHE" value=""></input> <span>Individuals with lower levels of screen time tend to have higher anxiety scores</span></label><label><input type="radio" autocomplete="off" name="radio_MBBTIXIWHE" value=""></input> <span>No association between screen time and anxiety scores is apparent</span></label><label><input type="radio" autocomplete="off" name="radio_MBBTIXIWHE" value="answer"></input> <span>Individuals with higher levels of screen time tend to have higher anxiety scores</span></label></div>
...
<div class='webex-radiogroup' id='radio_QAZJXEHWXH'><label><input type="radio" autocomplete="off" name="radio_QAZJXEHWXH" value=""></input> <span>predicted screen time = 5.59 + 0.13(anxiety score)</span></label><label><input type="radio" autocomplete="off" name="radio_QAZJXEHWXH" value="answer"></input> <span>predicted anxiety score = 5.59 + 0.13(screen_time)</span></label><label><input type="radio" autocomplete="off" name="radio_QAZJXEHWXH" value=""></input> <span>predicted anxiety score = 0.13 + 5.59(screen_time)</span></label></div>
...
<div class='webex-radiogroup' id='radio_AJBFEHKTOL'><label><input type="radio" autocomplete="off" name="radio_AJBFEHKTOL" value="answer"></input> <span>Predicted screen time = 7.48 - 0.10(age)</span></label><label><input type="radio" autocomplete="off" name="radio_AJBFEHKTOL" value=""></input> <span>Predicted screen time = 0.10 - 7.48(age)</span></label><label><input type="radio" autocomplete="off" name="radio_AJBFEHKTOL" value=""></input> <span>Predicted screen time = 7.48 + 0.10(age)</span></label></div>
...
<div class='webex-radiogroup' id='radio_GSJXJRGCAK'><label><input type="radio" autocomplete="off" name="radio_GSJXJRGCAK" value=""></input> <span>No</span></label><label><input type="radio" autocomplete="off" name="radio_GSJXJRGCAK" value="answer"></input> <span>Yes</span></label><label><input type="radio" autocomplete="off" name="radio_GSJXJRGCAK" value=""></input> <span>Cannot determine</span></label></div>
