...
<div class='webex-radiogroup' id='radio_JEBBOQKWUP'><label><input type="radio" autocomplete="off" name="radio_JEBBOQKWUP" value=""></input> <span>Individuals with lower levels of screen time tend to have higher anxiety scores</span></label><label><input type="radio" autocomplete="off" name="radio_JEBBOQKWUP" value=""></input> <span>No association between screen time and anxiety scores is apparent</span></label><label><input type="radio" autocomplete="off" name="radio_JEBBOQKWUP" value="answer"></input> <span>Individuals with higher levels of screen time tend to have higher anxiety scores</span></label></div>
...
<div class='webex-radiogroup' id='radio_OETQVWUHWX'><label><input type="radio" autocomplete="off" name="radio_OETQVWUHWX" value=""></input> <span>predicted screen time = 5.59 + 0.13(anxiety score)</span></label><label><input type="radio" autocomplete="off" name="radio_OETQVWUHWX" value="answer"></input> <span>predicted anxiety score = 5.59 + 0.13(screen_time)</span></label><label><input type="radio" autocomplete="off" name="radio_OETQVWUHWX" value=""></input> <span>predicted anxiety score = 0.13 + 5.59(screen_time)</span></label></div>
...
<div class='webex-radiogroup' id='radio_HQKIJOVRJW'><label><input type="radio" autocomplete="off" name="radio_HQKIJOVRJW" value=""></input> <span>Older individuals tend to have higher screen time scores</span></label><label><input type="radio" autocomplete="off" name="radio_HQKIJOVRJW" value="answer"></input> <span>Older individuals tend to have lower screen time scores</span></label><label><input type="radio" autocomplete="off" name="radio_HQKIJOVRJW" value=""></input> <span>No association between age and screen time appears to be present</span></label></div>
...
<div class='webex-radiogroup' id='radio_XYGNQKXFZX'><label><input type="radio" autocomplete="off" name="radio_XYGNQKXFZX" value="answer"></input> <span>Predicted screen time = 7.48 - 0.10(age)</span></label><label><input type="radio" autocomplete="off" name="radio_XYGNQKXFZX" value=""></input> <span>Predicted screen time = 0.10 - 7.48(age)</span></label><label><input type="radio" autocomplete="off" name="radio_XYGNQKXFZX" value=""></input> <span>Predicted screen time = 7.48 + 0.10(age)</span></label></div>
...
<div class='webex-radiogroup' id='radio_EJHAKEDDUG'><label><input type="radio" autocomplete="off" name="radio_EJHAKEDDUG" value=""></input> <span>No</span></label><label><input type="radio" autocomplete="off" name="radio_EJHAKEDDUG" value="answer"></input> <span>Yes</span></label><label><input type="radio" autocomplete="off" name="radio_EJHAKEDDUG" value=""></input> <span>Cannot determine</span></label></div>
